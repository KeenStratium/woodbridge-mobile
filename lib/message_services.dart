                  ...
                  child: Flex(
                    ...
                    children: <Widget>[
                      ...
                      widget.hasResponse
                          ...
                          : Container(),
                      widget.attachmentUrl != '' && widget.attachmentUrl != null
                          ? Container(
                              margin: EdgeInsets.symmetric(horizontal: 20.0),
                              padding: EdgeInsets.only(top: 20.0, bottom: 0.0),
                              child: Column(
                                              ...
                                              child: Flex(
                                                ...
                                                children: <Widget>[
                                                  Container(
                                                    ...
                                                    child: ClipRRect(
                                                      borderRadius:
                                                          BorderRadius.only(topLeft: Radius.circular(50.0), bottomLeft: Radius.circular(50.0)),
                                                      child: Container(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Center(
                                                                child: Text(
                                                                  ...
                                                                  style:
                                                                      TextStyle(fontSize: 14.0, fontWeight: FontWeight.w400, color: Colors.grey[600]),
                                                                ),
                                                              ),
                                                            ),
                                                          ),
