...
class ResponseButton extends StatefulWidget {
  ResponseButton({this.label, this.type, this.onTap, this.isActive});
...
class _BoardState extends State<Board> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.category.toLowerCase() == 'pdf') {
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Flex(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    widget.date != null || widget.time != null
                        ? Container(
                            child: Flex(
    ...
    if (isSuccess) {
      ...
      _messages = transformPaginationListCache(_studentNotifications, pageSize, offsetPage, (item, page, pageItemIndex, index) {
        ...
        try {
          ...
          String date = message['aa_event_date'];
          eventTime = message['aa_event_time'];
          eventDate = DateTime.parse(date);
          boardTitle = message['aa_subj'];
          boardDesc = message['aa_desc'];
          ...
          try {
            attachmentName = message['aa_attachment'];
            attachmentUrl = message['aa_attachment_url'];
          } catch (e) {
            print(e);
          }
        } catch (e) {
        ...
        return Column(
          children: <Widget>[
            ...
            Board(
              ...
              category: message['aa_category'],
              hasResponse: message['aa_category'] == 'appointment',
              notifId: message['id'],
              date: eventDate,
              time: eventTime,
